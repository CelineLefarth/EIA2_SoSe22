...
(function (L08_2_StrandCanvas) {
    ...
    function Wolke(context, _X, _Y) {
        let scale = ((context.canvas.width * 0.3) / 1000);
        console.log(scale);
        context.save();
    ...
    function Schwimmer(context, _X, _Y) {
        let scale = ((context.canvas.width) / 1000);
        console.log(scale);
        context.save();
        context.translate(context.canvas.width * _X, context.canvas.height * _Y);
        context.scale(scale, scale);
    ...
    function Boot(context, _X, _Y) {
        let scale = ((context.canvas.width * 2) / 1000);
        console.log(scale);
        context.save();
        context.translate(context.canvas.width * _X, context.canvas.height * _Y);
        context.scale(scale, scale);
    ...
    function Strandbesucher(context, _X, _Y) {
        let scale = ((context.canvas.width * 2) / 1000);
        console.log(scale);
        context.save();
        context.translate(context.canvas.width * _X, context.canvas.height * _Y);
